...
# Discussão
  ...
  A aplicação do método *Bootstrap*, se deu pelo fato da tentativa de contornar um problema recorrente de diversos estudos, a alta amplitude dos intervalos de confiança(referenciar), em geral causada pelo baixo número de casos(referenciar), 
