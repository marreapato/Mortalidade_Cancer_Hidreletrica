...
# Discussão
  ...
  Dentre os resultados obtidos, o câncer de esôfago apresenta uma maior chance de óbito entre os indivíduos expostos a eletricidade na companhia hidrelétrica, sendo que um valor elevado também foi verificado no método *bootstrap*, apesar disso tal chance elevada de óbito entra em contraste com dois estudos, um realizado em uma coorte de trabalhadores da industria de suprimento de energia elétrica do Reino Unido $\!\!^8$  em que o número de casos observados para o tumor em trabalhadores do sexo masculino ficou muito abaixo do esperado, segundo Sorahan (2019,p.344) “déficits significantivos foram revelados para as neoplasias malignas de língua, boca, faringe, esôfago, reto, rim, pâncreas , laringe e pulmão”, e outro realizado na Suécia $\!\!^1$ $\!\!^0$  referente a incidência de câncer e campos magnéticos em industrias suecas que utilizam solda por resistência em que não houve indicativo de risco elevado para o câncer de esôfago em nenhum nível de exposição a CEM.
...
# Conclusão
 ...
 Este estudo apresenta limitações similares a outros realizados como e bastante similar a um referente a exposição ocupacional a campos eletromagnéticos e câncer de mama em homens canadenses $\!\!^9$, em que a classificação de exposição foi feita considerando os indivíduos como expostos e não expostos podendo existir erros de classificação, além do grande número de índividuos em que não foi possível identificar a exposição, há também a dificuldade em afirmar uma chance maior de óbito se dá pelo fato da ocorrência do baixo número de casos, tal empecilho é responsável por gerar largos intervalos de confiança . Porventura, a falta de meios biológicos para determinar com maior precisão a exposição a eletricidade pode influenciar nos resultados finais, contudo mais estudos de longa escala e com um maior número de casos são necessários para definir os reais efeitos da exposição ocupacional a campos eletromagnéticos na mortalidade por câncer.
 
 Apesar das limitações, o presente estudo contribui com a apresentação de um método *bootstrap*
