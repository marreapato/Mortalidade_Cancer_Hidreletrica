...
# Resultados
 ...
 No método tradicional**(Tabela 1 em anexo)**, aplicado para o grupo A e dos trabalhadores falecidos por neoplasia sem contato com a eletricidade, apenas foi encontrada uma elevada chance de óbito para o câncer de esôfago(MOR=5,50; IC=1,06-28,33; P=0,0235), enquanto no método bootstrap**(Tabela 1 em anexo)**  a elevada chance de óbito se manteve para o tal(MORBoot=6,73; IC=1,74- 16,67; P<0,0001), houve também identificação de altas chances neste método para as neoplasias de bexiga(MORBoot=6,03; IC=2,62-10,81; P<0,0001), linfoma não hodgkin (MORBoot=6,03; IC=2,62-10,81; P<0,0001) e osso (MORBoot=3,95; IC=2,62-5,26; P<0,0001).

 Para os trabalhadores do grupo A em relação ao grupo C ao considerar a MOR**(Tabela 2 em anexo)**, a chance de óbito mais elevada permanece sendo pelo câncer de esôfago(MOR=7,42;IC=1,19-45,99, P=0,0128) para os empregados do grupo A, entretanto o intervalo de confiança foi muito largo, devido aos poucos casos referente a tal neoplasia nos grupos analisados, não houve nenhuma chance de óbito estatisticamente significante encontrada na comparação dos grupos A e B.
 
 
 Para a população brasileira do sexo feminino e as trabalhadoras da hidrelétrica**(Tabela 3 em anexo)**, há uma leve sugestão de uma chance maior de óbito para o câncer de ovário na hidrelétrica (MORH=16,00; IC=1,17-218,86; P=0,0114) em relação ao país (MORB=0,85; IC=0,83-0,87; P<0,0001) na faixa etária dos 70 a 79 anos, porém com uma alta amplitude no intervalo de confiança referente para MORH da companhia. Para a população brasileira e empregados do sexo masculino**(Tabela 4 em anexo)**, há a sugestão de uma maior chance de óbito para o câncer de laringe na hidrelétrica (MORH=7,90; IC=1,49-41,98; P=0,0040) em comparação ao Brasil (MORB=1,18; IC=1,15-1,19; P<0,0001) na faixa etária dos 60 a 69 anos. 
