...
# Discussão
  ...
  A aplicação do método *Bootstrap*, se deu pelo fato da tentativa de contornar um problema recorrente de diversos estudos, a alta amplitude dos intervalos de confiança(referenciar), em geral causada pelo baixo número de casos(referenciar), apesar da amplitude média do método bootstrap (amplitude média de 11,27) ter sido menor que a do tradicional (amplitude média de 13,23). Entretanto o coeficiente de variação do método bootstrap (0,6271) foi menor do que a da técnica tradicional (1,039), demonstrando uma menor variação nos intervalos de confiança do novo método em comparação com o tradicionalmente utilizado, tal fato gera uma melhor confiança na amplitude média a qual foi menor no método bootstrap, e revela uma maior estabilidade nos intervalos de tal método em relação ao tradicional.
