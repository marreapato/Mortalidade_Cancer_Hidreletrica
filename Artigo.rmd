...
# Discussão
  ...
  Para o câncer de bexiga, identificado com alta chance de óbito no método bootstrap, o mesmo estudo realizado na Suécia (Håkansson et al., 2002) cita que em um estudo anterior realizado em uma coorte populacional do país, foram achadas diversas associações leves entre a exposição a CEM e neoplasia maligna, dentre as quais e há a associação para homens expostos a campos eletromagnéticos e o câncer de bexiga. Outro estudo referente mortalidade por câncer em trabalhadores de uma companhia geradora de eletricidade do estado de São Paulo encontrou uma CPMR no câncer de bexiga elevada para trabalhadores com alta exposição a eletricidade segundo Mattos e Koifman (1996,p.568)“No grupo de alta exposição, foram encontradas CPMRs elevadas e estatisticamente significativas, embora com um IC amplo, devido ao pequeno número de casos,
para câncer de bexiga (CPMR 4,17; IC 95% 1,35-9,72)[. . . ]”, mais uma vez o fato de não haver o acesso aos hábitos de tabagismo dos trabalhadores pode ser um fator que dificulte a afirmação de uma maior chance de óbito para tal tumor.

Para o câncer de ossos o mesmo estudo realizado por Mattos e Koifman (1996), encontrou uma CPMR
elevada porém não significativa estatisticamente para tal tumor, enquanto para o linfoma não hodgkin um número de casos maior que o esperado foi encontrado na coorte de trabalhadores do Reino Unido no estudo realizado por Sorahan(2019).
