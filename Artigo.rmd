...
# Resultados
 ...
 No método tradicional**(Tabela 1 em anexo)** apenas foi encontrada uma elevada chance de óbito para o câncer de esôfago(MOR=5,50; IC=1,06-28,33; P=0,0235), enquanto no método bootstrap**(Tabela 1 em anexo)**  a elevada chance de óbito se manteve para o câncer de esôfago (MORBoot=6,73; IC=1,74- 16,67; P<0,0001),houve também identificação de altas chances neste método para as neoplasias de bexiga(MORBoot=6,03; IC=2,62-10,81; P<0,0001), linfoma não hodgkin (MORBoot=6,03; IC=2,62-10,81; P<0,0001) e osso (MORBoot=3,95; IC=2,62-5,26; P<0,0001).
