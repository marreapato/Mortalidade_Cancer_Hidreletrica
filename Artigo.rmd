...
# Introdução
 ...
 Visto que a intensidade de exposição ao CEM(campos eletromagnéticos de baixa frequência) em certos tipos de ocupações podem ser consideravelmente superiores a exposição residencial $\!\!^4$, após o marco de 1979 $\!\!^4$ \ $\!\!^5$ em que Wertheimer e Leeper trouxeram tal problemática a público ao demonstrar uma associação positiva entre o risco de leucemia infantil e a exposição a CEM(campos eletromagnéticos de baixa frequência), é pertinente a realização de estudos avaliando os possíveis riscos que tal exposição possa causar, principalmente após a IARC(Agência Internacional de Pesquisa em Câncer) $\!\!^2$ no ano de 2002 ter classificado os CEM como possivelmente carcinogênicos no grupo 2B $\!\!^4$ \ $\!\!^7$ \ $\!\!^9$, porém com evidências inadequadas para os outros tipos de câncer $\!\!^7$, no presente momento a classificação dada a IARC para os CEM é de 3(não classificado quanto a carcinogenicidade para humanos) $\!\!^2$. Câncer de mama $\!\!^9$, próstata $\!\!^3$, cérebro $\!\!^7$ e leucemia $\!\!^1$ $\!\!^3$ são apenas dos algumas das neoplasias que tiveram seu estudo direcionado a problemática da exposição aos CEM(campos eletro-magnéticos de baixa frequência),    
