...
#### Algoritmos e implementação
 ...
 O cálculo da MOR e o método *bootstrap* foram aplicados seguindo os seguintes passos...
...
for(m in 1:length(cancercsele$Var1)){
  ...
  a=newdata$Freq[newdata$Var1==1]#eletricidade e sem saude A
  
  c=sum(cancercsele$Freq)-a#eletricidade e com saude
  
  k=newdata$cancersemelet[newdata$Var1==1]#sem eletricidade e sem saude
