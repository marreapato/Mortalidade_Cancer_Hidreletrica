...
author:
  ...
  - name: Gecynalda Gomes
    ...
    email:  author2@work
abstract: >
 After a paper published in 1979 by Wertheimer and Leeper showed a positive association between extremely low-frequency magnetic fields (elf-mf) and infant leukemia, studies investigating risks between exposure to elf-mf and the development of diseases, subsequently caused the classification of this kind of exposure as 2B (Possibly carcinogenic) by IARC. This study aims to analyze deaths by malignant neoplasm and the risks occupational exposure to elf-mf may have as a co-carcinogenic or carcinogenic factor in a hydroelectric power facility located in Brazil. A database of 1,253 deceased workers from 1985 until 2011, where 249 were identified as exposed to electricity and 995 weren't , was used to evaluate the MOR, which was calculated accordingly to the exposure of those who died from malignant neoplasm, a bootstrap method was used to lower the amplitude of the confidence intervals and bring more reliable estimates to the MOR, a database of those who died of cancer in the country was gathered from a Brazilian information system maintained by INCA to compare the MOR regarding sex and age within the company and the country. When using the traditional method to calculate the MOR, an elevated value was found for esophagus cancer(MOR=5.50; CI=1.06-28.33; P=0.0235), whereas in the bootstrap method the MOR was high for the following cancer types: Esophagus(MORBoot=6.73; CI=1.74- 16.67; P<0.0001), Non Hodgkin Lymphoma(MORBoot=6.03; CI=2.62-10.81; P<0.0001), Bladder(MORBoot=6.03; CI=2.62-10.81; P<0.0001) and Bone(MORBoot=3.95; CI=2.62-5.26; P<0.0001). Some limitations of the study, such as lack of information about the lifestyle of the workers and the small number of cases, make more difficult to consider exposure to elf-mf as a carcinogenic or co-carcinogenic factor, but despite the limitations in this study, the elevated MORs and BootMORs should be taken seriously requiring further research and better-funded studies in the area.
...
![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\Tabela_boot_trad_unificada (1).pdf"){height=800px}

# Apêndice 2

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\tabela_grpA_C (3).pdf"){height=1200px,width=2000px}

# Apêndice 3

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\fem_cancer (3).pdf"){height=800px}

# Apêndice 4

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\Tabela-mor-masc1.pdf"){height=800px}

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\2mor.pdf"){height=800px}

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\3mor.pdf"){height=800px}

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\4mor.pdf"){height=800px}

![]("C:\Users\User\Desktop\pibic_NAOEXCLUIR\Mortalidade Hidreletrica\5mor.pdf"){height=800px}
