...
# Discussão
  ...
  A aplicação do método *Bootstrap*, se deu pelo fato da tentativa de contornar um problema recorrente de diversos estudos o baixo número de casos(referenciar), o que porventura acaba por aumentar a amplitude dos intervalos de confiança(referenciar), em relação ao método tradicional  
